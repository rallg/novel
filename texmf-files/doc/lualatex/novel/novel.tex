...
{\centering Version 1.86 (January 2024)\\
Consider the \emph{Novelette} document class package instead.\par}
\end{ChapterStart}
...
\QuickChapter{4. Version: 1.86, 2024: allow babel or polyglossia.}

\noindent 1.83-1.84, 2023: Minor typos corrected.

\noindent 1.82, 2023: Added user setting for default indent.

\noindent 1.81, 2023: Bug fixes. Also 1.81a, 1.81b.

\noindent 1.80, 2023: Class option ``rev'' for reversion.

\noindent 1.52 and earlier: from 2018.
